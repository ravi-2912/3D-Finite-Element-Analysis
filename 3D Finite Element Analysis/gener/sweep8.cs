...
namespace FEA3D.gener
{
    ...
    public class sweep8
    {
        ...
        private int nodeTypesNumbers2D()
        {
            ...
            {
                nodeNum2[i] = node;
                int dn = nlayers + 1;// (nodeType2[i] == 0) ? nlayers + 1 : 2 * nlayers + 1;
        ...
        private void elementConnectivities3D()
        {
            ...
            int[] ind2 = new int[4], t3 = new int[4],
                    n3 = new int[4], ind3 = new int[8];
            int iel3d = 0;
            ...
            for (int iel2d = 0; iel2d < m2.nEl; iel2d++)
            {
                ...
                for (int i3 = 0; i3 < nlayers; i3++)
                {
                    for (int i = 0; i < nind2; i++)
                    {
                        int dn = 1;//m3 (t3[i] == 0) ? 1 : 2;
                        int node = n3[i] + i3 * dn;
                        int dn2 = dn;
                        //int dn1 = 1;
                        // Node at rotation axis
                        if (rotate && m2.getNodeCoord(ind2[i], 0) == 0)
                        {
                            node = n3[i];
                            dn2 = 0;
                            //dn1 = 0;
                    ...
                    m3.elems[iel3d] = Element.newElement("hex8");
